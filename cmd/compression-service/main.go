...
import (
	...
	"github.com/bitstored/compression-service/pkg/server"
...
var (
	grpcAddr = flag.String("grpc", "localhost:4003", "gRPC API address")
	httpAddr = flag.String("http", "localhost:5003", "HTTP API address")
...
func main() {
	...
	service := service.NewCompressionService()
	...
	pb.RegisterCompressionServer(gRPCServer, devServer)
